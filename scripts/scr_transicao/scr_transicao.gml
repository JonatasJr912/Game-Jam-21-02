...
function destruindo_intro_tutorial()
{
     if (layer_exists("transicao_intro"))
    {
     
        audio_play_sound(snd_tema,1,1);   
        layer_destroy("transicao_intro");
        global.transicao = false;
        instance_create_layer(0,0,"UI",obj_nome_fase_tutorial);
        
    }
    
}

function criando_tutorial_move()
{
